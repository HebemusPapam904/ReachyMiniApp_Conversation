...
import conversation_relay.prompts as prompts_mod
import conversation_relay.personality as headless_mod
from conversation_relay.config import DEFAULT_PROFILES_DIRECTORY, config
from conversation_relay.personality import (
    DEFAULT_OPTION,
    read_tools_for,
    read_greeting_for,
    list_personalities,
...
#     \spaces--pollen-robotics--conversation_relay
...
#   back to the budget: 101 + len("conversation_relay\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="conversation_relay.prompts"):
