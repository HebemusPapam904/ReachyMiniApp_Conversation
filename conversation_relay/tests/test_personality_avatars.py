...
import conversation_relay.personality as personality_mod
from conversation_relay.config import config
from conversation_relay.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from conversation_relay.personality import DEFAULT_OPTION
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "conversation_relay.personality_routes.read_avatar_svg",
        lambda name: None,
    )
