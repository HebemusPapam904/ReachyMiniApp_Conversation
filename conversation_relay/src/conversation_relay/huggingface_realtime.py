...
from conversation_relay.tools import core_tools
...
from conversation_relay.prompts import (
    get_session_voice,
    get_session_instructions,
    get_session_greeting_prompt,
)
from conversation_relay.streaming import AdditionalOutputs, audio_to_int16
from conversation_relay.tools.core_tools import (
    ToolSpec,
    ToolDependencies,
    get_tool_specs,
)
from conversation_relay.conversation_handler import ConversationHandler
from conversation_relay.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class HuggingFaceRealtimeHandler(ConversationHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from conversation_relay.config import config as _config
