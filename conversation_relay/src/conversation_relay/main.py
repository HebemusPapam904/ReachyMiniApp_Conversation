...
from conversation_relay import app_lifecycle
from conversation_relay.utils import (
    parse_args,
    setup_logger,
...
def main() -> None:
    ...
    if args.command == "tool-spaces":
        from conversation_relay.tool_spaces import handle_tool_spaces_command
...
def run(
    ...
    from conversation_relay.moves import MovementManager
    ...
    from conversation_relay.console import LocalStream
    from conversation_relay.tools.core_tools import ToolDependencies, initialize_tools
    ...
    def build_handler(startup_voice: Optional[str] = None) -> ConversationHandler:
        ...
        from conversation_relay.huggingface_realtime import HuggingFaceRealtimeHandler
...
class ConversationRelay(ReachyMiniApp):  # type: ignore[misc]
